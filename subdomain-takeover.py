#!/usr/bin/env python
#
# SubDomain TakeOver - SubDomain takeover vulnerability scanner
# Coded by Nishit (nishitm)
...
def help():
    ...
    print("Example:")
    print("\t%s --sub-domain sub.example.com" % (sys.argv[0]))
...
def main():
    ...
    if sub_domain:
        ...
        if service and error:
            ...
            plus('A potential TAKEOVER vulnerability!')
